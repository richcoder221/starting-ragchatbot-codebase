...
class TestGenerateResponseDirectAnswer:
    ...
    def test_tools_and_tool_choice_passed_when_provided(self, generator):
        ...
        generator.generate_response("question", tools=tool_defs, tool_manager=MagicMock())
        call_kwargs = generator.client.chat.completions.create.call_args[1]
...
class TestHandleToolExecution:
    def test_tool_call_triggers_handle_tool_execution(self, generator):
        ...
        first_response = make_mock_response(finish_reason="tool_calls", tool_calls=[tool_call])
        second_response = make_mock_response(content="Final answer after tool.", finish_reason="stop")
    ...
    def test_tool_result_included_in_follow_up_messages(self, generator):
        tool_call = make_tool_call("call_abc", "search_course_content", {"query": "embeddings"})
        first_response = make_mock_response(finish_reason="tool_calls", tool_calls=[tool_call])
        second_response = make_mock_response(content="Embeddings are...", finish_reason="stop")
        generator.client.chat.completions.create.side_effect = [first_response, second_response]
        ...
        tools = [{"type": "function", "function": {"name": "search_course_content"}}]
        generator.generate_response("Explain embeddings", tools=tools, tool_manager=mock_tool_manager)

        second_call_kwargs = generator.client.chat.completions.create.call_args_list[1][1]
    ...
    def test_assistant_message_with_none_content_does_not_raise(self, generator):
        ...
        first_response = make_mock_response(content=None, finish_reason="tool_calls", tool_calls=[tool_call])
        second_response = make_mock_response(content="Final answer.", finish_reason="stop")
        generator.client.chat.completions.create.side_effect = [first_response, second_response]
    ...
    def test_tool_arguments_are_parsed_from_json(self, generator):
        ...
        tool_call = make_tool_call(
            "call_x", "search_course_content", {"query": "MCP", "course_name": "MCP Course", "lesson_number": 2}
        )
        first_response = make_mock_response(finish_reason="tool_calls", tool_calls=[tool_call])
        ...
        mock_tool_manager.execute_tool.assert_called_once_with(
            "search_course_content", query="MCP", course_name="MCP Course", lesson_number=2
        )
...
class TestMultipleToolCalls:
    def test_multiple_sequential_tool_calls(self, generator):
        ...
        tool_call_1 = make_tool_call("call_1", "get_course_outline", {"course_name": "Course X"})
        tool_call_2 = make_tool_call("call_2", "search_course_content", {"query": "lesson 4 topic"})

        first_response = make_mock_response(finish_reason="tool_calls", tool_calls=[tool_call_1])
        second_response = make_mock_response(finish_reason="tool_calls", tool_calls=[tool_call_2])
        third_response = make_mock_response(content="Final answer after two tools.", finish_reason="stop")
        generator.client.chat.completions.create.side_effect = [first_response, second_response, third_response]

        mock_tool_manager = MagicMock()
        mock_tool_manager.execute_tool.side_effect = ["Course outline content.", "Related course found."]
    ...
    def test_tools_included_in_follow_up_requests(self, generator):
        ...
        tools = [{"type": "function", "function": {"name": "search_course_content"}}]
        generator.generate_response("question", tools=tools, tool_manager=mock_tool_manager)
    ...
    def test_all_tool_results_in_final_request_messages(self, generator):
        ...
        tool_call_1 = make_tool_call("call_1", "get_course_outline", {"course_name": "Course X"})
        tool_call_2 = make_tool_call("call_2", "search_course_content", {"query": "topic"})
        ...
        tools = [{"type": "function", "function": {"name": "get_course_outline"}}]
        generator.generate_response("complex question", tools=tools, tool_manager=mock_tool_manager)

        third_call_kwargs = generator.client.chat.completions.create.call_args_list[2][1]
